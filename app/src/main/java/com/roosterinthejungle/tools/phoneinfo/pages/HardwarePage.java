...
import com.roosterinthejungle.tools.phoneinfo.MainActivity;
...
public class HardwarePage extends BasePage {
    ...
    public void onResume() {
        ...
        mTvGpuRenderer.setText(((MainActivity) getActivity()).getGlRenderer().getName());
        mTvGpuVendor.setText(((MainActivity) getActivity()).getGlRenderer().getVendor());
    }
    ...
    protected void createPanels() {
        ...
        panel = createPanel(getString(R.string.lb_panel_camera));
        addRow(panel, getString(R.string.lb_back), df.format(mPhoneInfo.getBackCameraMegapixels()) + " Megapixels", true);
        addRow(panel, getString(R.string.lb_front), df.format(mPhoneInfo.getFrontCameraMegapixels()) + " Megapixels", false);
